...
<nav id="sidebar" class="w-60 min-h-screen bg-sg-navy fixed top-0 left-0 z-[1040] flex flex-col overflow-y-auto">
    ...
    <div class="px-3 pt-4 pb-1">
        ...
        <a class="sb-item flex items-center gap-2.5 px-3 py-2.5 rounded-xl cursor-pointer text-sm font-medium text-white/55 hover:bg-white/[0.07] hover:text-white/85 transition-all mb-0.5" onclick="showPage('laporan',this)">
    ...
    <div class="px-3 pt-4 pb-1">
        ...
        <a class="sb-item flex items-center gap-2.5 px-3 py-2.5 rounded-xl cursor-pointer text-sm font-medium text-white/55 hover:bg-white/[0.07] hover:text-white/85 transition-all mb-0.5" onclick="showPage('pengaturan',this)">

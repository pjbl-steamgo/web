...
<div id="modal-tambah-antrian" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]">Tambah Antrian Baru</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
    <div class="p-6 grid grid-cols-2 gap-3">
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nama Pelanggan</label>
            <input id="new-antrian-pelanggan" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" placeholder="Nama pelanggan...">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Kendaraan</label>
            <select id="new-antrian-kendaraan" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Motor</option>
                <option>Mobil</option>
            </select>
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Layanan</label>
            <select id="new-antrian-layanan" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Steam Biasa Motor</option>
                <option>Snow Wash Motor</option>
                <option>Detailing Motor</option>
                <option>Steam Biasa Mobil</option>
                <option>Snow Wash Mobil</option>
                <option>Detailing Mobil</option>
            </select>
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Jam</label>
            <input id="new-antrian-jam" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" type="time" value="10:00">
        </div>
    </div>
...
<div id="modal-tambah-layanan" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    ...
    <div class="p-6 grid grid-cols-2 gap-3">
        <div class="col-span-2">
            ...
            <input id="new-layanan-nama" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" placeholder="Cth: Snow Wash Motor">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Jenis Kendaraan</label>
            <select id="new-layanan-jenis" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Motor</option>
                <option>Mobil</option>
            </select>
        </div>
        <div>
            ...
            <input id="new-layanan-harga" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" type="number" placeholder="25000">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Estimasi (menit)</label>
            <input id="new-layanan-durasi" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" type="number" placeholder="30">
        </div>
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Deskripsi</label>
            <textarea id="new-layanan-deskripsi" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" rows="3" placeholder="Deskripsi layanan..."></textarea>
        </div>
    </div>
    <div class="flex gap-2 px-6 py-4 border-t border-sg-border">
...
<div id="modal-edit-layanan" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]">Edit Layanan</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
    <div class="p-6 grid grid-cols-2 gap-3">
        ...
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nama Layanan</label>
            <input id="edit-layanan-nama" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Harga (Rp)</label>
            <input id="edit-layanan-harga" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" type="number">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Estimasi (menit)</label>
            <input id="edit-layanan-durasi" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" type="number">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Status</label>
            <select id="edit-layanan-status" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Aktif</option>
        ...
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Deskripsi</label>
            <textarea id="edit-layanan-deskripsi" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" rows="2"></textarea>
        </div>
    </div>
    <div class="flex gap-2 px-6 py-4 border-t border-sg-border">
        <button class="bg-white text-sg-text border border-sg-border font-semibold rounded-xl px-4 py-2 text-sm" onclick="closeModal()">Batal</button>
...
<div id="modal-tambah-pelanggan" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]">Tambah Pelanggan Baru</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
    <div class="p-6 grid grid-cols-2 gap-3">
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nama Lengkap</label>
            <input id="new-pelanggan-nama" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" placeholder="Nama pelanggan...">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nomor HP</label>
            <input id="new-pelanggan-hp" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" placeholder="08xx-xxxx-xxxx">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Member</label>
            <select id="new-pelanggan-member" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Baru</option>
...
<div id="modal-edit-pelanggan" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]">Edit Data Pelanggan</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
    <div class="p-6 grid grid-cols-2 gap-3">
        ...
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nama Lengkap</label>
            <input id="edit-pelanggan-nama" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nomor HP</label>
            <input id="edit-pelanggan-hp" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Member</label>
            <select id="edit-pelanggan-member" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Baru</option>
                <option>Silver</option>
                <option>Gold</option>
            </select>
...
<div id="modal-detail-pelanggan" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]">Detail Pelanggan</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
    <div class="p-6">
        ...
        <div class="grid grid-cols-3 gap-2 mb-4">
            <div class="text-center p-3 rounded-xl bg-sg-bg">
                <div class="font-display text-[22px] font-black" id="detail-pelanggan-steam">—</div>
                <div class="text-[11px] text-sg-sub">Total Steam</div>
            </div>
            <div class="text-center p-3 rounded-xl bg-sg-bg">
                <div class="font-display text-[22px] font-black text-sg-blue" id="detail-pelanggan-bayar">—</div>
                <div class="text-[11px] text-sg-sub">Total Bayar</div>
            </div>
            <div class="text-center p-3 rounded-xl bg-sg-bg">
                <div class="font-display text-[22px] font-black text-sg-orange">4.8⭐</div>
                <div class="text-[11px] text-sg-sub">Rating</div>
            </div>
        </div>
    </div>
    <div class="flex gap-2 px-6 py-4 border-t border-sg-border">
...
<div id="modal-detail-pesanan" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]" id="detail-pesanan-kode">Detail Pesanan</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
...
<div id="modal-edit-antrian" class="modal-panel hidden fixed z-[2001] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl">
    <div class="flex items-center justify-between px-6 py-4 border-b border-sg-border">
        <h5 class="font-display font-bold text-[17px]">Edit Antrian</h5>
        <button class="text-sg-sub hover:text-sg-text" onclick="closeModal()">✕</button>
    </div>
    <div class="p-6 grid grid-cols-2 gap-3">
        ...
        <div class="col-span-2">
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Nama Pelanggan</label>
            <input id="edit-antrian-pelanggan" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
        </div>
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Layanan</label>
            <select id="edit-antrian-layanan" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue">
                <option>Steam Biasa Motor</option>
                <option>Snow Wash Motor</option>
                <option>Detailing Motor</option>
                <option>Steam Biasa Mobil</option>
        ...
        <div>
            <label class="block text-[11px] font-bold text-sg-sub uppercase tracking-wide mb-1">Jam</label>
            <input id="edit-antrian-jam" class="w-full bg-sg-bg border border-sg-border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-sg-blue" type="time">
        </div>
    </div>
    <div class="flex gap-2 px-6 py-4 border-t border-sg-border">
        <button class="bg-white text-sg-text border border-sg-border font-semibold rounded-xl px-4 py-2 text-sm" onclick="closeModal()">Batal</button>
